...
import { Navbar }   from './components/jam/Navbar';
import { Title }    from './components/jam/Title';
import { Register } from './components/jam/Register';
import { Schedule } from './components/jam/Schedule';
import { Games }    from './components/jam/Games';
import { Sponsors } from './components/jam/Sponsors';
import { Footer }   from './components/jam/Footer';
import { Theme }    from './components/jam/Theme';
...
const GameJam = ({ classes, rootClassName, className, ...props }) => {
    return (
